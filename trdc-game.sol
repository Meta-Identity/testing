...
contract TRDCvalut is BEP20 {
  ...
  modifier isWhitelisted(address _beneficiary) {
    ...
    constructor () BEP20("TRDCGame", "TG") payable{
        ...
        currency = BEP20(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47);
    }
  ...
  function buyCard() external payable returns(uint256 CardPower) {
      ...
      _getPower();
      //iBEP20(currency).approve(address(this), 1);
      //emit BuyCard(msg.sender, 1);
      //iBEP20(currency).transferFrom(msg.sender, address(this), cardPrice);//Trasfer from User to this contract TRDC token (price of game card)
